...
namespace Flocking
{
    ...
    public partial class SystemSampledAnimationClipPlayback : SystemBase
    {
        protected override void OnUpdate()
        {
            var deltaTime = math.min(0.05f, SystemAPI.Time.DeltaTime);

            Entities.ForEach((ref LocalTransform transform, in ComponentSampledAnimationClip sampledAnimationClip) =>
            {
            ...
            Entities.ForEach((ref ComponentSampledAnimationClip sampledAnimationClip) =>
            {
